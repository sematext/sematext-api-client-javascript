  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dayUsageData'))
        obj.dayUsageData = ApiClient.convertToType(data['dayUsageData'], [
          DayUsageData
        ])
      if (data.hasOwnProperty('monthlyFeeAmount'))
        obj.monthlyFeeAmount = ApiClient.convertToType(
          data['monthlyFeeAmount'],
          'Number'
        )
      if (data.hasOwnProperty('periodFeePeriods'))
        obj.periodFeePeriods = ApiClient.convertToType(
          data['periodFeePeriods'],
          [MinPeriodFeePeriod]
        )
