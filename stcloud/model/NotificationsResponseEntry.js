 ...
 * @version 0.4.0
 */
export class NotificationsResponseEntry {
  /**
 ...
 * @member {String} end
 */
NotificationsResponseEntry.prototype.end = undefined

/**
 * @member {Array.<module:model/AlertNotification>} notifications
 */
NotificationsResponseEntry.prototype.notifications = undefined

/**
 * @member {String} start
 */
NotificationsResponseEntry.prototype.start = undefined
