  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dailyVolumeMB'))
        obj.dailyVolumeMB = ApiClient.convertToType(
          data['dailyVolumeMB'],
          'Number'
        )
      ...
      if (data.hasOwnProperty('limitChangeEvents'))
        obj.limitChangeEvents = ApiClient.convertToType(
          data['limitChangeEvents'],
          [LimitChangeEventDTO]
        )
      if (data.hasOwnProperty('maxAllowedMB'))
        obj.maxAllowedMB = ApiClient.convertToType(
          data['maxAllowedMB'],
          'Number'
        )
      ...
      if (data.hasOwnProperty('volumeChangeEvents'))
        obj.volumeChangeEvents = ApiClient.convertToType(
          data['volumeChangeEvents'],
          [LimitChangeEventDTO]
        )
    }
    return obj
