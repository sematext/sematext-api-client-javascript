...
export class AlertRule {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('accountEmail'))  // eslint-disable-line no-prototype-builtins
        obj.accountEmail = ApiClient.convertToType(data['accountEmail'], 'String')
      if (data.hasOwnProperty('allowedAppTypes'))  // eslint-disable-line no-prototype-builtins
        obj.allowedAppTypes = ApiClient.convertToType(data['allowedAppTypes'], ['Number'])
      if (data.hasOwnProperty('analyzingTime'))  // eslint-disable-line no-prototype-builtins
        obj.analyzingTime = ApiClient.convertToType(data['analyzingTime'], 'String')
      if (data.hasOwnProperty('appDisplayState')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('appName')) // eslint-disable-line no-prototype-builtins
        obj.appName = ApiClient.convertToType(data['appName'], 'String')
      if (data.hasOwnProperty('appState')) // eslint-disable-line no-prototype-builtins
        obj.appState = ApiClient.convertToType(data['appState'], 'String')
      if (data.hasOwnProperty('appToken')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('backToNormalNeeded')) // eslint-disable-line no-prototype-builtins
        obj.backToNormalNeeded = ApiClient.convertToType(data['backToNormalNeeded'], 'Boolean')
      if (data.hasOwnProperty('chartKey')) // eslint-disable-line no-prototype-builtins
        obj.chartKey = ApiClient.convertToType(data['chartKey'], 'String')
      if (data.hasOwnProperty('color')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('defaultAggType')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('disallowedAppTypes')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('estimateOperation')) // eslint-disable-line no-prototype-builtins
        obj.estimateOperation = ApiClient.convertToType(data['estimateOperation'], 'String')
      if (data.hasOwnProperty('estimateValue')) // eslint-disable-line no-prototype-builtins
        obj.estimateValue = ApiClient.convertToType(data['estimateValue'], 'Number')
      if (data.hasOwnProperty('filterValues')) // eslint-disable-line no-prototype-builtins
        obj.filterValues = ApiClient.convertToType(data['filterValues'], 'String')
      if (data.hasOwnProperty('filterValuesObj')) // eslint-disable-line no-prototype-builtins
        obj.filterValuesObj = ApiClient.convertToType(data['filterValuesObj'], [FilterValue])
      if (data.hasOwnProperty('ignoreRegularEventsEnabled')) // eslint-disable-line no-prototype-builtins
        obj.ignoreRegularEventsEnabled = ApiClient.convertToType(data['ignoreRegularEventsEnabled'], 'Boolean')
      if (data.hasOwnProperty('integrations')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('lastSent')) // eslint-disable-line no-prototype-builtins
        obj.lastSent = ApiClient.convertToType(data['lastSent'], 'Number')
      if (data.hasOwnProperty('lastTriggered')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('metricKey')) // eslint-disable-line no-prototype-builtins
        obj.metricKey = ApiClient.convertToType(data['metricKey'], 'String')
      if (data.hasOwnProperty('metricLabel')) // eslint-disable-line no-prototype-builtins
        obj.metricLabel = ApiClient.convertToType(data['metricLabel'], 'String')
      if (data.hasOwnProperty('minDelayBetweenNotificationsInMinutes')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('notificationEmails')) // eslint-disable-line no-prototype-builtins
        obj.notificationEmails = ApiClient.convertToType(data['notificationEmails'], ['String'])
      if (data.hasOwnProperty('notificationIntegrations')) // eslint-disable-line no-prototype-builtins
        obj.notificationIntegrations = ApiClient.convertToType(data['notificationIntegrations'], [NotificationIntegration])
      if (data.hasOwnProperty('notificationsEnabled')) // eslint-disable-line no-prototype-builtins
        obj.notificationsEnabled = ApiClient.convertToType(data['notificationsEnabled'], 'Boolean')
      if (data.hasOwnProperty('query')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('ruleKey')) // eslint-disable-line no-prototype-builtins
        obj.ruleKey = ApiClient.convertToType(data['ruleKey'], 'Number')
      if (data.hasOwnProperty('ruleType')) // eslint-disable-line no-prototype-builtins
        obj.ruleType = ApiClient.convertToType(data['ruleType'], 'String')
      if (data.hasOwnProperty('runbook')) // eslint-disable-line no-prototype-builtins
        obj.runbook = ApiClient.convertToType(data['runbook'], 'String')
      if (data.hasOwnProperty('savedQueryId')) // eslint-disable-line no-prototype-builtins
        obj.savedQueryId = ApiClient.convertToType(data['savedQueryId'], 'Number')
      if (data.hasOwnProperty('schedule')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('sendToEmail')) // eslint-disable-line no-prototype-builtins
        obj.sendToEmail = ApiClient.convertToType(data['sendToEmail'], 'String')
      if (data.hasOwnProperty('timezone')) // eslint-disable-line no-prototype-builtins
        obj.timezone = ApiClient.convertToType(data['timezone'], 'String')
      if (data.hasOwnProperty('useOnlyAlertRuleIntegrations')) // eslint-disable-line no-prototype-builtins
      ...
      if (data.hasOwnProperty('valueColumnName')) // eslint-disable-line no-prototype-builtins
        obj.valueColumnName = ApiClient.convertToType(data['valueColumnName'], 'String')
      if (data.hasOwnProperty('valueName')) // eslint-disable-line no-prototype-builtins
