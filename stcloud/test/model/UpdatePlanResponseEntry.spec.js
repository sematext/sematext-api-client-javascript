...
(function (root, factory) {
  ...
  describe('UpdatePlanResponseEntry', function () {
    it('should create an instance of UpdatePlanResponseEntry', function () {
      // uncomment below and update the code to test UpdatePlanResponseEntry
      //var instane = new SematextApiClientJavascript.UpdatePlanResponseEntry();
      //expect(instance).to.be.a(SematextApiClientJavascript.UpdatePlanResponseEntry);
    });
