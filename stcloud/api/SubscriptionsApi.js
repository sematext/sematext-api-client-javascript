...
export class SubscriptionsApi {
  ...
  createForAppUsingPOSTWithHttpInfo (body, appId) {
    ...
    if (appId === undefined || appId === null) {
      throw new Error(
        "Missing the required parameter 'appId' when calling createForAppUsingPOST"
      )
    }
  ...
  createForAppUsingPOST (body, appId) {
    return this.createForAppUsingPOSTWithHttpInfo(body, appId).then(function (
      response_and_data
    ) {
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/SubscriptionResponse} and HTTP response
   */
  createForDashUsingPOST1WithHttpInfo (body, dashId) {
    let postBody = body
    // verify the required parameter 'body' is set
    if (body === undefined || body === null) {
      throw new Error(
    ...
    if (dashId === undefined || dashId === null) {
      throw new Error(
        "Missing the required parameter 'dashId' when calling createForDashUsingPOST1"
      )
    }
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/SubscriptionResponse}
   */
  createForDashUsingPOST1 (body, dashId) {
    return this.createForDashUsingPOST1WithHttpInfo(body, dashId).then(
  ...
  deleteUsingDELETE2WithHttpInfo (updateableSubscriptionId) {
    ...
    if (
      updateableSubscriptionId === undefined ||
      updateableSubscriptionId === null
    ) {
      throw new Error(
        "Missing the required parameter 'updateableSubscriptionId' when calling deleteUsingDELETE2"
      )
    }
  ...
  deleteUsingDELETE2 (updateableSubscriptionId) {
    return this.deleteUsingDELETE2WithHttpInfo(updateableSubscriptionId).then(
      function (response_and_data) {
        return response_and_data.data
      }
    )
  ...
  listUsingGET3WithHttpInfo (appId) {
    ...
    if (appId === undefined || appId === null) {
      throw new Error(
        "Missing the required parameter 'appId' when calling listUsingGET3"
      )
    }
   ...
   */
  listUsingGET3 (appId) {
    return this.listUsingGET3WithHttpInfo(appId).then(function (
      response_and_data
    ) {
      return response_and_data.data
    })
   ...
   */
  listUsingGET5 () {
    return this.listUsingGET5WithHttpInfo().then(function (response_and_data) {
      return response_and_data.data
    })
  }
   ...
   */
  sendAppReportUsingPOSTWithHttpInfo (body, appId) {
    let postBody = body
    // verify the required parameter 'body' is set
    if (body === undefined || body === null) {
      throw new Error(
    ...
    if (appId === undefined || appId === null) {
      throw new Error(
        "Missing the required parameter 'appId' when calling sendAppReportUsingPOST"
      )
    }
   ...
   */
  sendAppReportUsingPOST (body, appId) {
    return this.sendAppReportUsingPOSTWithHttpInfo(body, appId).then(function (
      response_and_data
    ) {
      return response_and_data.data
    })
  ...
  sendDashReportUsingPOSTWithHttpInfo (body, dashId) {
    ...
    if (dashId === undefined || dashId === null) {
      throw new Error(
        "Missing the required parameter 'dashId' when calling sendDashReportUsingPOST"
      )
    }
  ...
  sendDashReportUsingPOST (body, dashId) {
    return this.sendDashReportUsingPOSTWithHttpInfo(body, dashId).then(
      function (response_and_data) {
        return response_and_data.data
      }
    )
  ...
  toggleEnabledUsingPUT1WithHttpInfo (body, updateableSubscriptionId) {
    ...
    if (
      ...
      throw new Error(
        "Missing the required parameter 'updateableSubscriptionId' when calling toggleEnabledUsingPUT1"
      )
    }
  ...
  toggleEnabledUsingPUT1 (body, updateableSubscriptionId) {
    return this.toggleEnabledUsingPUT1WithHttpInfo(
      body,
  ...
  updateForAppUsingPUTWithHttpInfo (body, appId) {
    ...
    if (appId === undefined || appId === null) {
      throw new Error(
        "Missing the required parameter 'appId' when calling updateForAppUsingPUT"
      )
    }
  ...
  updateForAppUsingPUT (body, appId) {
    return this.updateForAppUsingPUTWithHttpInfo(body, appId).then(function (
      response_and_data
    ) {
      return response_and_data.data
    })
  ...
  updateForDashUsingPUT1WithHttpInfo (body, dashId) {
    ...
    if (dashId === undefined || dashId === null) {
      throw new Error(
        "Missing the required parameter 'dashId' when calling updateForDashUsingPUT1"
      )
    }
  ...
  updateForDashUsingPUT1 (body, dashId) {
    return this.updateForDashUsingPUT1WithHttpInfo(body, dashId).then(function (
      response_and_data
    ) {
      return response_and_data.data
    })
