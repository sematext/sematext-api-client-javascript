...
export class AppsApi {
  ...
  deleteUsingDELETEWithHttpInfo (anyStateAppId) {
    ...
    if (anyStateAppId === undefined || anyStateAppId === null) {
      throw new Error(
        "Missing the required parameter 'anyStateAppId' when calling deleteUsingDELETE"
      )
    }
  ...
  deleteUsingDELETE (anyStateAppId) {
    return this.deleteUsingDELETEWithHttpInfo(anyStateAppId).then(function (
      response_and_data
    ) {
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GenericMapBasedApiResponse} and HTTP response
   */
  inviteAppGuestsUsingPOSTWithHttpInfo (body) {
    let postBody = body
    // verify the required parameter 'body' is set
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling inviteAppGuestsUsingPOST"
      )
    }
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GenericMapBasedApiResponse}
   */
  inviteAppGuestsUsingPOST (body) {
    return this.inviteAppGuestsUsingPOSTWithHttpInfo(body).then(function (
      response_and_data
    ) {
      return response_and_data.data
    })
  ...
  updateDescriptionUsingPUT1WithHttpInfo (anyStateAppId, opts) {
    ...
    if (anyStateAppId === undefined || anyStateAppId === null) {
      throw new Error(
        "Missing the required parameter 'anyStateAppId' when calling updateDescriptionUsingPUT1"
      )
    }
  ...
  updateDescriptionUsingPUT1 (anyStateAppId, opts) {
    return this.updateDescriptionUsingPUT1WithHttpInfo(
      anyStateAppId,
      opts
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AppResponse} and HTTP response
   */
  updateUsingPUT2WithHttpInfo (body, anyStateAppId) {
    let postBody = body
    // verify the required parameter 'body' is set
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling updateUsingPUT2"
      )
    }
    // verify the required parameter 'anyStateAppId' is set
    if (anyStateAppId === undefined || anyStateAppId === null) {
      throw new Error(
        "Missing the required parameter 'anyStateAppId' when calling updateUsingPUT2"
      )
    }
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AppResponse}
   */
  updateUsingPUT2 (body, anyStateAppId) {
    return this.updateUsingPUT2WithHttpInfo(body, anyStateAppId).then(function (
      response_and_data
    ) {
      return response_and_data.data
    })
