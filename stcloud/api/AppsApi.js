...
export class AppsApi {
  ...
  inviteAppGuestsUsingPOST(invitation) {
    return this.inviteAppGuestsUsingPOSTWithHttpInfo(invitation)
      .then(function(response_and_data) {
        return response_and_data.data
      })
  }
  ...
  listAppsUsersUsingGET() {
    return this.listAppsUsersUsingGETWithHttpInfo()
      .then(function(response_and_data) {
        return response_and_data.data
      })
  }
  ...
  updateDescriptionUsingPUT(anyStateAppId, opts) {
    return this.updateDescriptionUsingPUTWithHttpInfo(anyStateAppId, opts)
      .then(function(response_and_data) {
        return response_and_data.data
      })
  }
  ...
  updateUsingPUT1(dto, anyStateAppId) {
    return this.updateUsingPUT1WithHttpInfo(dto, anyStateAppId)
      .then(function(response_and_data) {
        return response_and_data.data
      })
  }
