...
export class BillingApi {
    ...
    */
    ...
    listAvailablePlansUsingGET1WithHttpInfo(opts) {
      ...
      let queryParams = {
        'integrationId': opts['integrationId'],'appType': opts['appType']
      };
      let headerParams = {
    ...
    listAvailablePlansUsingGET1(opts) {
      return this.listAvailablePlansUsingGET1WithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    updatePlanUsingPUTWithHttpInfo(body, appId) {
      ...
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updatePlanUsingPUT");
      }
