...
export class ResetPasswordApi {
    ...
    */
     ...
     */
    resetPasswordUsingPOST1WithHttpInfo(body) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling resetPasswordUsingPOST1");
      }
     ...
     */
    resetPasswordUsingPOST1(body) {
      return this.resetPasswordUsingPOST1WithHttpInfo(body)
