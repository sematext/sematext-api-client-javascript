...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SematextCloudApi.LogsAppApi = factory(root.SematextCloudApi.ApiClient, root.SematextCloudApi.CreateAppInfo, root.SematextCloudApi.GenericApiResponse);
  }
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createLogseneApplication operation.
     * @callback module:api/LogsAppApi~createLogseneApplicationCallback
     ...
     * @param {module:api/LogsAppApi~createLogseneApplicationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GenericApiResponse}
     */
    this.createLogseneApplication = function(applicationDetails, callback) {
      ...
      if (applicationDetails === undefined || applicationDetails === null) {
        throw new Error("Missing the required parameter 'applicationDetails' when calling createLogseneApplication");
      }
