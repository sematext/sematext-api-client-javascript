...
apiInstance.deleteSavedQueryUsingDELETE(updateableQueryId).then(
  data => {
...
apiInstance.getSavedQueriesForAppUsingGET(appId).then(
  data => {
    console.log('API called successfully. Returned data: ' + data)
  },
  error => {
...
apiInstance.saveQueryUsingPOST(savedQueryDto).then(
  data => {
    console.log('API called successfully. Returned data: ' + data)
  },
  error => {
...
apiInstance.saveQueryUsingPUT(savedQueryDto, updateableQueryId).then(
  data => {
    console.log('API called successfully. Returned data: ' + data)
  },
  error => {
