...
apiInstance.inviteAppGuestsUsingPOST(invitation).then(
  data => {
    console.log('API called successfully. Returned data: ' + data)
  },
  error => {
...
apiInstance.updateDescriptionUsingPUT(anyStateAppId, opts).then(
  data => {
    console.log('API called successfully. Returned data: ' + data)
  },
  error => {
...
apiInstance.updateUsingPUT1(dto, anyStateAppId).then(
  data => {
    console.log('API called successfully. Returned data: ' + data)
  },
  error => {
