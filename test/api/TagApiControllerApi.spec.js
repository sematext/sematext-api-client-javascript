...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TagApiControllerApi', function() {
      ...
      describe('getTagsGroupedByIdUsingGET1', function() {
        it('should call getTagsGroupedByIdUsingGET1 successfully', function(done) {
          // TODO: uncomment, update parameter values for getTagsGroupedByIdUsingGET1 call and complete the assertions
          /*
          var opts = {};

          instance.getTagsGroupedByIdUsingGET1(appIds, tag, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SematextApiClientJavascript.TagsGroupedResponse);
