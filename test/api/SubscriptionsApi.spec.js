    ...
    describe('SubscriptionsApi', function() {
      ...
      describe('createForDashUsingPOST', function() {
        it('should call createForDashUsingPOST successfully', function(done) {
          // TODO: uncomment, update parameter values for createForDashUsingPOST call and complete the assertions
          /*

          instance.createForDashUsingPOST(body, dashId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SematextApiClientJavascript.SubscriptionResponse);
      ...
      describe('deleteUsingDELETE3', function() {
        it('should call deleteUsingDELETE3 successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteUsingDELETE3 call and complete the assertions
          /*

          instance.deleteUsingDELETE3(updateableSubscriptionId).then(function(data) {
            // TODO: update response assertions
      ...
      describe('sendAppReportUsingPOST1', function() {
        it('should call sendAppReportUsingPOST1 successfully', function(done) {
          // TODO: uncomment, update parameter values for sendAppReportUsingPOST1 call and complete the assertions
          /*

          instance.sendAppReportUsingPOST1(body, appId).then(function(data) {
            // TODO: update response assertions
      ...
      describe('toggleEnabledUsingPUT', function() {
        it('should call toggleEnabledUsingPUT successfully', function(done) {
          // TODO: uncomment, update parameter values for toggleEnabledUsingPUT call and complete the assertions
          /*

          instance.toggleEnabledUsingPUT(body, updateableSubscriptionId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SematextApiClientJavascript.SubscriptionResponse);
