...
;(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TokensApiControllerApi', function () {
      describe('createAppToken1', function () {
        it('should call createAppToken1 successfully', function (done) {
          // TODO: uncomment, update parameter values for createAppToken1 call and complete the assertions
          /*

          instance.createAppToken1(body, appId).then(function(data) {
      ...
      describe('getAppTokens', function () {
        it('should call getAppTokens successfully', function (done) {
          // TODO: uncomment, update parameter values for getAppTokens call and complete the assertions
          /*

          instance.getAppTokens(appId).then(function(data) {
            // TODO: update response assertions
      ...
      describe('updateAppToken1', function () {
        it('should call updateAppToken1 successfully', function (done) {
          // TODO: uncomment, update parameter values for updateAppToken1 call and complete the assertions
          /*

          instance.updateAppToken1(body, appId, tokenId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SematextApiClientJavascript.TokenResponse);
