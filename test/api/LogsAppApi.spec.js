...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SematextCloudApi.LogsAppApi();
  });
    ...
    describe('LogsAppApi', function() {
      describe('createLogseneApplication', function() {
        it('should call createLogseneApplication successfully', function(done) {
          ...
          /*
          var applicationDetails = new SematextCloudApi.CreateAppInfo();
          applicationDetails.appType = "aws";
          applicationDetails.discountCode = "";
          applicationDetails.initialPlanId = 1;
          applicationDetails.metaData = new SematextCloudApi.AppMetadata();
          ...
          instance.createLogseneApplication(applicationDetails, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
