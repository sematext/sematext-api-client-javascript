  ...
  describe('(package)', function () {
    describe('App', function () {
      ...
      it('should have the property readToken (base name: "readToken")', function () {
        // TODO: update the code to test the property readToken
        expect(instance).to.have.property('readToken')
        // expect(instance.readToken).to.be(expectedValueLiteral);
      })

      it('should have the property readWriteToken (base name: "readWriteToken")', function () {
        // TODO: update the code to test the property readWriteToken
        expect(instance).to.have.property('readWriteToken')
        // expect(instance.readWriteToken).to.be(expectedValueLiteral);
      })
      ...
      it('should have the property writeToken (base name: "writeToken")', function () {
        // TODO: update the code to test the property writeToken
        expect(instance).to.have.property('writeToken')
        // expect(instance.writeToken).to.be(expectedValueLiteral);
      })
    })
  })
})
